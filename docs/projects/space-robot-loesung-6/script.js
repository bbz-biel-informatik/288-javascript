// Lösung Kapitel 6 - Vergleiche
// Der Spielzustand wird mit Vergleichen aus den Leben abgeleitet.
...
// NEU (Aufgabe 6.2): Zweite Anzeige für den Spielzustand
...
function gameLoop() {
  ...
  // NEU (Aufgabe 6.2): Spielzustand aus den Leben ableiten
  if (life >= 800) {
